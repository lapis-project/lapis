...
const { countAnswersForQuestion, getValuesForQuestion } = useQuestions();
...
const variantCount = computed(() => {
    return countAnswersForQuestion(props.activeQuestion ?? "").map(entry => ({ ...entry, value: entry.rel }))
})
...
class="w-full" :count="answerCount" :phenomenon="activeQuestion"
                        ...
                        <TabsContent value="variant"></TabsContent>
