...
const bibliography = new Hono<AppEnv>()
	 ...
	 *
	 * - This endpoint automatically calculates and includes absolute URLs for the current, next, and
	 *   previous pages based on the incoming request URL to facilitate the frontend navigation.
	 *
	 ...
	 * @returns {Object} 200 - JSON object containing the data payload, total page count, and
	 *   pagination URLs (`currentUrl`, `nextUrl`, `prevUrl`).
